        ...
        <div class="block">
            ...
            <table class="floated-form-table form-table">
                <tr valign="top">
                    ...
                    <td>
                        Size: <input type="text" name="cmtoc_table_of_contentsLevel0Size" value="<?php echo get_option('cmtoc_table_of_contentsLevel0Size'); ?>" /></td>
                    <td colspan="2" class="cmtoc_field_help_container">Set the style of table-of-content title (if set)</td>
                </tr>
                <tr valign="top">
                    <th scope="row">Level 1:</th>
                    <td>
                        Size: <input type="text" name="cmtoc_table_of_contentsLevel1Size" value="<?php echo get_option('cmtoc_table_of_contentsLevel1Size'); ?>" /></td>
                    <td colspan="2" class="cmtoc_field_help_container">Set the style of table-of-content description</td>
                </tr>
                <tr valign="top">
                    <th scope="row">Level 2:</th>
                    <td>
                        Size: <input type="text" name="cmtoc_table_of_contentsLevel2Size" value="<?php echo get_option('cmtoc_table_of_contentsLevel2Size'); ?>" /></td>
                    <td colspan="2" class="cmtoc_field_help_container">Set the style of table-of-content description</td>
                </tr>
                <tr valign="top">
                    <th scope="row">Level 3:</th>
                    <td>
                        Size: <input type="text" name="cmtoc_table_of_contentsLevel3Size" value="<?php echo get_option('cmtoc_table_of_contentsLevel3Size'); ?>" /></td>
                    <td colspan="2" class="cmtoc_field_help_container">Set the style of table-of-content description</td>
                </tr>
                <tr valign="top">
                    <th scope="row">Level 4:</th>
                    <td>
                        Size: <input type="text" name="cmtoc_table_of_contentsLevel4Size" value="<?php echo get_option('cmtoc_table_of_contentsLevel4Size'); ?>" /></td>
                    <td colspan="2" class="cmtoc_field_help_container">Set the style of table-of-content description</td>
                </tr>
                <tr valign="top">
                    <th scope="row">Level 5:</th>
                    <td>
                        Size: <input type="text" name="cmtoc_table_of_contentsLevel5Size" value="<?php echo get_option('cmtoc_table_of_contentsLevel5Size'); ?>" /></td>
                    <td colspan="2" class="cmtoc_field_help_container">Set the style of table-of-content description</td>
                </tr>
            </table>
        </div>
