...
Tags: table-of-content,pages,posts,definitions,automatic,hints,category,listing,cms,index,indexes,list,table of contents,toc,html,tag,class,shortcode,table of contents plugin,table of contents,table plugin wordpress,wordpress table of contents,wordpress table of contents plugin,table plugin,navigation table plugin,wordpress 
navigation plugin,wordpress navigation table plugin,table of contents wordpress
Requires at least: 3.9
Tested up to: 4.3.0
Stable tag: 1.0.2

Create a table of contents and help users navigate your WordPress site. Define the content sections using customizable headers and css classes.

== Description ==

Add a navigation table to any page or post of your WordPress site with the CreativeMinds Table of Contents plugin.
Customize your table of contents with different sections and headers, defined by your page or post content.
This WordPress plugin helps your site users easily navigate between different sections of your content and improves their overall experience.

[youtube https://www.youtube.com/watch?v=D8RgPD_Lj1A]

**Basic Table of Content Plugin Features**
...
**How to Use the Table of Contents Plugin**
...
> #### Plugin Site
> * [TOC Plugin Site](https://www.cminds.com/store/purchase-cm-table-of-content-plugin-for-wordpress/)
> * [Plugin Pro Version Features](https://www.cminds.com/store/purchase-cm-table-of-content-plugin-for-wordpress/)
